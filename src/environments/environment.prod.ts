...
export const environment = {
  ...
  nikshayStates_url: `${adminBaseUrl}nikshay/location/states`,
  nikshayDistricts_url: `${adminBaseUrl}nikshay/location/districts`,
  ...
  get_FacilityTypesByState_Url: `${adminBaseUrl}getFacilityTypesByState`,
  ...
  // User Facility Mapping URLs
  saveUserFacilityMapping_Url: `${adminBaseUrl}userFacilityMapping/save`,
  updateUserFacilityMapping_Url: `${adminBaseUrl}userFacilityMapping/update`,
  deleteUserFacilityMapping_Url: `${adminBaseUrl}userFacilityMapping/delete`,
  getUserFacilityMappingByProvider_Url: `${adminBaseUrl}userFacilityMapping/getByProvider`,
  getVillagesByFacility_Url: `${adminBaseUrl}userFacilityMapping/getVillagesByFacility`,
